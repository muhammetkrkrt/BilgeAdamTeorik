...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("Adı: " + anahtar1.ad + " Rengi: " + anahtar1.renk + " No: " + anahtar1.no + " Uzunluk: "
				+ Anahtar.uzunluk);
		...
		System.out.println("Adı: " + anahtar2.ad + " Rengi: " + anahtar2.renk + " No: " + anahtar2.no + " Uzunluk: "
				+ Anahtar.uzunluk);

		// Anahtar.uzunluk = 20; // bu cümlede sadece anahtar3'ü değil tü anahtar
		// nesnelerinin uzunluğunu değiştiriyorum
		...
		System.out.println("Adı: " + anahtar3.ad + " Rengi: " + anahtar3.renk + " No: " + anahtar3.no + " Uzunluk: "
				+ Anahtar.uzunluk);
		...
		// metodu static olmadığı için sınıf adı ile çağırılamaz
