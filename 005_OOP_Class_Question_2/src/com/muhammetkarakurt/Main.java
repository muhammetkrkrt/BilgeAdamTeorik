...
public class Main {
	public static void main(String[] args) {
		Diktorgen dikdortgen1 = new Diktorgen();
		dikdortgen1.kisaKenar = 7;
		dikdortgen1.uzunKenar = 10;

		Diktorgen dikdortgen2 = new Diktorgen();
		...
		// paralelKenar1.kenarKisa = 30; --> erişilemez çünkü access modifier default
		// yani protected olarak tanımlandı
		// paralelKenar2.kenarKisa = 50; --> erişilemez çünkü access modifier default
		// yani protected olarak tanımlandı
		...
		// ikizkenarUcgen.kenarlariUzat(5); -> protected olduğu için farklı paketlerden
		// erişilemez bu metoda
		...
		// Daire daire1 = new Daire(); --> Daire sınıfı başka bir pakette ve protected
		// (package specific) olduğu için
