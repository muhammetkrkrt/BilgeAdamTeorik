...
public class Question4 {
	...
	public static void main(String[] args) {
		...
		// arrayler parametre olarak gönderilirse array içeriğine bir referans gider,
		// içerik kopyalanmaz
		...
		// değişkenlerde durum farklı, ilkel tipler parametre olarak giderse içerik
		// kopyalanır, referans gitmez
		int sayi = 1;
		test(sayi);
