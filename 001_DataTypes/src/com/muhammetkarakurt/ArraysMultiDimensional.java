...
public class ArraysMultiDimensional {
	...
	public static void main(String[] args) {
		...
		// int [][] cokBoyutluDizi2 = { {1,2,3}, {4,5,6} }; -->> üst satırdakiyle aynı
		// tanımlama
		...
		// Böyle satır satır yazmak çok uzun sürüyor, burada 3 değil 500 kayıt olsaydı
		// ne yapacaktık?
		...
		// Code Refining:
		//
		// Burada 3 (satır) ve 4 (sütun) sayılarını kod içine yukarıdaki gibi gömmek
		// doğru değil.
