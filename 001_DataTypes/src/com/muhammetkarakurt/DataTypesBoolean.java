...
public class DataTypesBoolean {
	...
	public static void main(String[] args) {
		// BOOLEAN (bool) : en küçük veri tipi. 1 bit yer kaplar. 1 ya da 0 değeri
		// tutuyor. mantıksal bir değer tutuyor.
		// açık-kapalı, doğru-yanlış, 1-0 şeklinde kullanılır.
		// boolean olarak neler tutulabilir?
		// Örn. bir kullanıcının sistemde aktif olup olmadığı (online-offline),
		// veritabanında bir verinin silinip silinmediği
		...
		boolean agirMi = false; // initialize: (ilk değer verme) değişkeni tanımladığım satırda ona bir değer
								// atıyorsam "initialize"
//		boolean agirMi2;
//		agirMi2 = false; // yukarıda tek satırdaki tanımı iki satır halinde de yapabilirim. aynısı.
		...
		System.out.println("Durum: " + durum); // ağırlığım 50 olmadığı için false dönüyor. int agirlik 50 olursa true
												// dönüyor.

		// durum = agirlik != 50; bu satırın sonucunu yazdırmak istersem 50 ye eşit
		// olmadığında true olur, 50'ye eşitse false olur
		...
		double res = x / y; //
		System.out.println("res: " + res); // küsürat göstemek istemiştim ama göremedim. çünkü eşitliğin sağ tarafı hep
											// int olur
