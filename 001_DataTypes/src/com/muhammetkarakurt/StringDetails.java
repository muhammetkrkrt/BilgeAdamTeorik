...
//		}
		...
		// * * * * * * * * *
		// equalsIgnoreCase metodu: metin karşılaştırması yaparken küçük harf büyük harf
		// ayrımını dikkate almaz
		...
		// Boşluk karakteri - ile değiştirilmeli, Türkçe karakterler ingilizce ile
		// değiştirilip sistemde öyle saklanmalı
		dosyaAdi = dosyaAdi.replace(" ", "-").replace("ş", "s");
		System.out.println(dosyaAdi);

		// * * * * * * * * *
		// contains metodu: Herhangi bir substringin hedef string içinde var olup
		...
		// * * * * * * * * *
		// startsWith metodu: Bir stringin bir stringle başlayıp başlamadığını kontrol
		// eder
		String ad = "Ali Kaya";
...
//		}
		...
		// Örnek: öğrenci listesi String olarak tutuluyor olsun. listeyi aytıştırmak
		// istiyorum:
		...
		// * * * * * * * * *
		// stringbuilder kullanımı : char arrayleriyle çalıştığı için memoryde
		// stringlere ekleme yapmak yerine daha az yer kaplar
		//
