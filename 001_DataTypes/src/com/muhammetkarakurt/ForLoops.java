...
//		System.out.println("Merhaba 3");
		...
		// int i; // ambiguity --> Döngülerde kullandığımız sayaç değişken isimlerini
		// kod içinde kullanmamalıyız kafa karışıklığını önlemek için.
		System.out.println("\n* * * *\n");

		// Soru
		for (int i = 0; i < 3; i++)
			; // Hiçbir işe yaramayan döngü oldu

		for (int i = 0; i < 3; i++) // Soldaki blok 3 kere Merhaba 1 kere Dünya yazar. For döngüsünün altındaki
									// satır döngüye girer
...
//			}
		...
		// Soru:
		// Aşağıdaki kodu çalıştırınca kaç kere test yazar? -->> 1 kere yazar. ilk
		// girince 10, ikinciye 11 < 11 koşulunu
		// sağlamadığı için dönmez ve çıkar
		// Bu şekilde for döngüsü içinde index'i değiştirmek tavsiye edilmez.
		// Eğer kod bloğu içinde indexi (sayacı) değiştirmeniz gereken durumlar oluyorsa
		// "while" veya "do while"
