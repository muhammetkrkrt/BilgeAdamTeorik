...
public class DataTypesDecimals {

	public static void main(String[] args) {
		// FLOAT 4 byte
		// Precision (noktadan sonraki hassasiyet): 7 decimal digits
		// Bilimsel hesaplamalarda kullanırsak veri kaybedebiliriz, sonuç yanlış
		// çıkabilir.
		// memoryde olabildiğince az yer tutup, düşük ondalıklı hesaplar yapmak için
		// kullanılır.
