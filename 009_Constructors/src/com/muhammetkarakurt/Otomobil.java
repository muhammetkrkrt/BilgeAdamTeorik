...
public class Otomobil {
	...
	private Motor motor; // Otomobil sınıfının içinde farklı bir sınıfın nesnesini üye değişken olarak
							// tutuyorum
	...
	public Otomobil(String marka, String model, int yil, int aracinKm, int motorHacmi, String saseNo,
			int yakitTuketimi) {
	...
	public Otomobil(String model, int yil, Motor motor) {
		this.model = model; // setModel() metodunda kontrol olmadığı için direkt böyle kullanabilirim. eğer
							// bir kontrol olsaydı setModel() kullanmalıydım
		this.yil = yil; // setYil() metodunda kontrol olmadığı için direkt böyle kullanabilirim. eğer
						// bir kontrol olsaydı setYil() kullanmalıydım
